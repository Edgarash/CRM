  ...
  Selectpicker.prototype = {
    ...
    createDropdown: function () {
      ...
      var drop =
          ...
          '<button type="button" class="' + this.options.styleBase + ' dropdown-toggle" ' + (this.options.display === 'static' ? 'data-display="static"' : '') + 'data-toggle="dropdown"' + autofocus + ' role="button" style="height:24px">' +
