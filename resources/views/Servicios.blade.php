            ...
            <tbody>
                ...
                <tr id="/Servicio/{{$servicio->id}}">
                    ...
                    <td class="text-center">
                        <a data-toggle="tooltip" title="Modificar nombre de: {{$servicio->servicio}}" data-placement="left"><i
...
<div class="text-center">
    <button class="btn btn-primary pull-right" style="margin-top: 20px">Nueva Servicio</button>
</div>
@else
